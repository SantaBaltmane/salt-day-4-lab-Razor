...
namespace Salt.Stars.API.Tests
{
  ...
  public class HeroesController_HappyPath
  {
    ...
    public HeroesController_HappyPath()
    {
      ...
      _apiClientMock.Setup(apiClient => apiClient.getHeroFromSwapi(It.IsAny<short>()).Result).Returns(MOCK_HERO_DATA);

      this.controller = new HeroesController(_apiClientMock.Object);
    }
